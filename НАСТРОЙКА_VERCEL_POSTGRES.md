...
1. **Перейдите в Vercel Marketplace:**
   - Откройте https://vercel.com/marketplace
   - Или в вашем проекте Vercel перейдите в **Settings** → **Integrations** → **Browse Marketplace**
   - Или найдите в меню проекта раздел **Marketplace**

2. **Найдите Neon:**
   - В разделе **Native Storage Integrations** найдите карточку **Neon**
   - Описание: "Serverless, scalable, secure PostgreSQL and Redis databases"
   - Нажмите на карточку Neon

3. **Установите интеграцию:**
   - На странице Neon нажмите **Install** или **Add Integration**
   - Выберите ваш проект `tg-catalog` (или другое имя)
   - Нажмите **Add** или **Install**

### Шаг 2: Создание базы данных

**Вариант A: Через Marketplace (после установки интеграции)**

1. **После установки интеграции Neon:**
   - Вас перенаправит на страницу настройки Neon
   - Или перейдите в ваш проект Vercel → **Storage** (если вкладка есть)
   - Или перейдите в **Settings** → **Integrations** → найдите Neon

2. **Создайте базу данных:**
   - Нажмите **Create Database** или **New Database**
   - Выберите регион (ближайший к вашим пользователям)
   - Выберите план:
     - **Free** - для начала (512 MB storage, 0.5 CPU)
     - **Launch** - для продакшена ($19/месяц)
   - Нажмите **Continue** или **Create**

3. **Назовите базу данных:**
   - Введите имя: `tg-catalog-db` (или любое другое)
   - Нажмите **Create**

**Вариант B: Прямо на сайте Neon (если интеграция не работает)**
...
2. **Скопируйте connection string:**
   ...
   - Найдите **Connection string** или **Connection Details**
   - Скопируйте строку подключения (начинается с `postgresql://`)

3. **Добавьте в Vercel:**
   - В вашем проекте Vercel: **Settings** → **Environment Variables**
   - Добавьте переменную:
     - **Name:** `DATABASE_URL`
...
1. **Проверьте переменные окружения:**
   ...
   - Если переменной нет, добавьте вручную (см. Вариант B выше)
